...
public class Ten {
    private class BinarySearch {
        ...
        /**
         * Returns the index of the specified key in the specified array. LOWER INDEX!
         *
         * @param a   the array of integers, must be sorted in ascending order
         * @param key the search key
         * @return index of key in array {@code a} if present; {@code -1} otherwise
         */
        public static int indexOfLowerIndex(int[] a, int key) {
            int lo = 0;
            int hi = a.length - 1;
            int result = -1;
            while (lo <= hi) {
        ...
        public static void main(String[] args) {
            ...
            while (!StdIn.isEmpty()) {
                ...
                keys.add(key);
                if (test.chapter1.one.BinarySearch.indexOf(allowlist, key) == -1) {
            ...
            int[] noDuplicateSolution = test.chapter1.one.BinarySearch.indexOfWithDuplicatesRemoved(
                    allowlist,
                    keys.stream()
                        .mapToInt(
                                Integer::intValue)
    ...
    public static void main(String[] args) {
        ...
        // Exampple comparing the indexOfLowerIndex and indexOf methods
        int[] a = { 1, 2, 3, 4, 5, 5, 5, 6, 7, 8, 9 };
        int key = 5;
        System.out.println("indexOfLowerIndex: " + BinarySearch.indexOfLowerIndex(a, key));
        System.out.println("indexOf: " + BinarySearch.indexOf(a, key));
